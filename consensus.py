...
#    parser.add_argument('-r', '--path_to_reads', default=os.path.join(os.getcwd(), ''),
...
#                        help='Полный путь к папке с полимеразными прочтениями')
#
#
...
def build_consensus(adapter_fasta, 
    ...
    try:
        ...
        print('Ошибка в обрезке адаптеров')
        print('--------------------------------------------------')
        return 0
    ...
    try:
        ...
        print('Ошибка в поиске стартовых позиций')
        print('--------------------------------------------------')
        return 0
    ...
    # Получение одного консенсуса из прямого и обратного консенсуса
        ...
        print('Ошибка в составлении консенсуса')
        print('--------------------------------------------------')
        return 0
